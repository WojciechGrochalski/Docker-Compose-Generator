...
def create_version_section():
    return [
        ...
        [
            sg.pin(sg.Text("Version: ", font='8', key='-version-', pad=((90, 0), (20, 0)), )),
            sg.pin(sg.In(size=(25, 1), pad=((10, 0), (20, 0)), enable_events=True, key='-selected-version-value-')),
        ], [
            sg.pin(sg.Button('Apply', size=(12, 1), pad=((190, 0), (20, 0)), enable_events=True, key='-save-version-'))
        ]
    ]
