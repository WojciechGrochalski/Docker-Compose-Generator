...
def createImageSection():
    return [
        ...
        [
            ...
            sg.pin(
                sg.In(size=(25, 1), font='12', pad=((5, 20), (20, 0)), enable_events=True, key='-image-name-value-')),
        ], [
            sg.pin(sg.Button('Apply', font='14', size=(12, 1), pad=((140, 0), (20, 0)), enable_events=True,
                             key='-save-image-')),
